...
#define
mDnsName="http://your-jsondata.com"
...
def get_jsonData():
    ...
    sMsg = "ok, temperature is " +str(result["temperature"])+ " degree"
    sMsg+= " , and  humidity is " +str(result["humidity"]) + " %"
    sMsg+= " , now time is " + sHH+" hour "+ sMM+ " minute"
    speech_output =sMsg
...
def on_intent(intent_request, session):
    ...
    if intent_name == "checkSensorIntent":
        return get_jsonData()
    else:
